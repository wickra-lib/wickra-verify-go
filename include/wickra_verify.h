/* wickra-verify C ABI — generated by cbindgen; do not edit by hand. */

#ifndef WICKRA_VERIFY_H
#define WICKRA_VERIFY_H
...
#define WICKRA_VERIFY_ERR_NULL -1

// `cmd_json` was not valid UTF-8.
#define WICKRA_VERIFY_ERR_UTF8 -2

// A panic was caught at the FFI boundary.
#define WICKRA_VERIFY_ERR_PANIC -3
...
typedef struct WickraVerify WickraVerify;
...
int32_t wickra_verify_command(WickraVerify *handle, const char *cmd_json, char *out, uintptr_t cap);
